<template>
  <div class="container mx-auto">
    ...
    <div class="bg-orange-100  py-10 px-4">
      ...
      <h3 class="font-light text-xl py-5">Conheça nossa equipe
        multidisciplinar, composta por
        profissionais renomados e
      ...
      <div class="flex pt-10 gap-3">
        ...
        <div>
          ...
          <p class="text-sm">
            ...
            de novas técnicas e tratamentos para o
            lipedema.</p>
      ...
      <div class="flex pt-10 gap-3">
        <div>
          <h1 class="text-3xl font-serif  ">ALESSANDRA NÓBREGA
          </h1>
          <p>FISIOTERAPEUTA</p>
          ...
          <p class="text-xl py-2">Especialização em Fisioterapia Vascular e
            Dermatofuncional</p>
